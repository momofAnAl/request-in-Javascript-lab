...
//   sayHelloButton.classList.add('black-button');
// } 
function changeButtonStyle () {
  sayHelloButton.style.backgroundColor = 'black';
  sayHelloButton.style.color = 'white'  
}
// attach mouseover event to sayHelloButton
sayHelloButton.addEventListener('mouseover', changeButtonStyle);
...
sayHelloButton.addEventListener('mouseout', changeBackStyle);
...
const ohMy = () => {
  ...
  .then(response => {
    ...
    for (i = 0; i < data.length; i++) {
      ...
      //its textContent equal the string at the current index (i)
